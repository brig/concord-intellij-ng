...
public class ElAccessExprImpl extends ASTWrapperPsiElement implements ElAccessExpr {
  ...
  @Override
  @NotNull
  public ElPrimaryExpr getPrimaryExpr() {
    return findNotNullChildByClass(ElPrimaryExpr.class);
  }
