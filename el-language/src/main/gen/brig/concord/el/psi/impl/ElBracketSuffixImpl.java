...
public class ElBracketSuffixImpl extends ASTWrapperPsiElement implements ElBracketSuffix {

  public ElBracketSuffixImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public ElExpression getExpression() {
    return findChildByClass(ElExpression.class);
  }
