...
public class ElAndExprImpl extends ASTWrapperPsiElement implements ElAndExpr {
  ...
  @Override
  @NotNull
  public List<ElEqExpr> getEqExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ElEqExpr.class);
  }
