...
public class ElMulExprImpl extends ASTWrapperPsiElement implements ElMulExpr {

  public ElMulExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ElUnaryExpr> getUnaryExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ElUnaryExpr.class);
  }
