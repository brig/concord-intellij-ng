...
public class CodeStyleSettingsProvider
    extends LanguageCodeStyleSettingsProvider {
        private static class Holder {
            ...
            private static final String[] ALIGN_OPTIONS = new String[]{
                    ConcordBundle.message("YAMLLanguageCodeStyleSettingsProvider.align.options.no"),
                    ConcordBundle.message("YAMLLanguageCodeStyleSettingsProvider.align.options.colon"),
                    ConcordBundle.message("YAMLLanguageCodeStyleSettingsProvider.align.options.value")
            };
        }
        ...
        final @NotNull CodeStyleSettings originalSettings) {
            return new CodeStyleAbstractConfigurable(settings, originalSettings, ConcordLanguage.INSTANCE.getDisplayName()) {
                @Override
                protected @NotNull CodeStyleAbstractPanel createPanel(final @NotNull CodeStyleSettings settings) {
                    final CodeStyleSettings currentSettings = getCurrentSettings();
                    return new TabbedLanguageCodeStylePanel(ConcordLanguage.INSTANCE, currentSettings, settings) {
                        @Override
                        protected void initTabs(final CodeStyleSettings settings) {
                            addIndentOptionsTab(settings);
                            addSpacesTab(settings);
                            addWrappingAndBracesTab(settings);
                            addTab(new GenerationCodeStylePanel(settings, ConcordLanguage.INSTANCE));
                        }
                    };
                }
        ...
        public String getConfigurableDisplayName() {
            return ConcordLanguage.INSTANCE.getDisplayName();
        }
        ...
        public void customizeSettings(@NotNull CodeStyleSettingsCustomizable consumer, @NotNull SettingsType settingsType) {
            if (settingsType == SettingsType.INDENT_SETTINGS) {
                ...
                consumer.showCustomOption(YAMLCodeStyleSettings.class, "SPACE_BEFORE_COLON", ConcordBundle.message(
                ...
                consumer.showCustomOption(YAMLCodeStyleSettings.class,
                        ...
                        ConcordBundle.message("YAMLLanguageCodeStyleSettingsProvider.align.values"),
                        null,
                ...
                consumer.showCustomOption(YAMLCodeStyleSettings.class,
                        ...
                        ConcordBundle.message("YAMLLanguageCodeStyleSettingsProvider.sequence.on.new.line"),
        ...
        public String getCodeSample(@NotNull SettingsType settingsType) {
            return CodeStyleAbstractPanel.readFromFile(ConcordBundle.class, "indents.yml");
        }
    ...
    class GenerationCodeStylePanel extends CodeStyleAbstractPanel {
        ...
        GenerationCodeStylePanel(@NotNull CodeStyleSettings settings, Language language) {
            ...
            myCommenterForm.getCommenterPanel().setBorder(
                    IdeBorderFactory.createTitledBorder(ConcordBundle.message("settings.comment.label"), true, new JBInsets(10, 10, 10, 10)));
        }
