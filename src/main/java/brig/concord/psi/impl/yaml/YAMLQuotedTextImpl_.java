...
import brig.concord.yaml.psi.impl.YAMLScalarImpl;
import brig.concord.yaml.psi.impl.YamlScalarTextEvaluator;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

// TODO: remove me when YAMLQuotedTextImpl will be not final
public class YAMLQuotedTextImpl_ extends YAMLScalarImpl implements YAMLQuotedText {

    private final boolean myIsSingleQuoted;

    public YAMLQuotedTextImpl_(@NotNull ASTNode node) {
        super(node);
    ...
    public @NotNull YamlScalarTextEvaluator getTextEvaluator() {
        return new YAMLQuotedTextTextEvaluator_(this);
    }
    ...
    static class YAMLQuotedTextTextEvaluator_ extends YamlScalarTextEvaluator<YAMLQuotedTextImpl_> {

        YAMLQuotedTextTextEvaluator_(YAMLQuotedTextImpl_ text) {
            super(text);
        }
