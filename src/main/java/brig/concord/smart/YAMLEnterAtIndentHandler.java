...
import static brig.concord.smart.YamlIndentPreservationUtilsKt.preserveIndentStateBeforeProcessing;
    ...
    public Result preprocessEnter(@NotNull PsiFile file,
        ...
        if (caretOffset.get() > 0 && shouldInsertAutomaticHyphen(file)) {
            ...
            if (PsiUtilCore.getElementType(element) == TokenType.WHITE_SPACE &&
                ...
                int indentSize = Objects.requireNonNull(CodeStyle.getLanguageSettings(file, ConcordLanguage.INSTANCE).getIndentOptions()).INDENT_SIZE;
