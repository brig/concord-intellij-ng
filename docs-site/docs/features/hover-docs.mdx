...
:::tip
Documentation popups are available in the completion list too. While the suggestion list is open, press <Keystroke mac={[{icon: "⌃", label: "Ctrl"}, {label: "Q"}]} win={[{label: "Ctrl"}, {label: "Q"}]} /> to preview the documentation for the selected item.
:::
