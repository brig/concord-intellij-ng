...
:::note
Function completion only appears at the top level of an expression — not after a dot. After a dot, the plugin shows [property completion](#expression-property-completion) instead.
:::
