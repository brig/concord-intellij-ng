...
- show `mvn.json` read errors in the repositories settings page
([#173](https://github.com/brig/concord-intellij-ng/pull/173))
...
([#150](https://github.com/brig/concord-intellij-ng/pull/150))
